...
import type { Resource, CollectionsInResource, CollectionsWithResource } from '#/project'
...
import type { TableProjectResources } from '@/components/project/projectResources/useProjectResources.ts'
